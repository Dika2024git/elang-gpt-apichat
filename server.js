...
const chatbotData = [
    ...
    },
    {
        ...
        responses: ["⚠️ Demi keamanan, jangan bagikan informasi pribadi di sini!"]
    },
    {
...
app.get("/chat/", apiKeyMiddleware, (req, res) => {
    const userId = req.query.userId || "guest";
    const userInput = req.query.text;

    if (!userInput) {
        return res.json({ reply: "Silakan masukkan pertanyaan dengan /chat?text=pertanyaanmu" });
    }
...
app.listen(PORT, () => {
    console.log(`Chatbot AI Elang GPT Berjalan!`);
});